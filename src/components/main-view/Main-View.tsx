...
function MainView() {
  ...
  window.addEventListener("scroll", () => {
    ...
    const maxVerticalHeight = (window.innerWidth >870 && window.innerWidth <1235) ?3005 :window.innerWidth >1235?3655: 4200; // Maximum height for the vertical bar 3655
    const maxHorizontalWidth = 720; // 45rem in pixels
    const maxVerticalHeight2 = window.innerWidth<1235 ? 4460: 5500; // Example value for second vertical line
    ...
    <div className="view h-full">
      ...
      >
        <div
          ...
          className="min-h-[25rem] max-h-[3610px] max-mobile:max-h-[4200px] max-tablet:max-h-[2750px] setOverflow  absolute ml-80 max-mobile:ml-[3rem] max-tablet:ml-[15rem]  p-[2px] z-0 rounded-3xl bg-myTeal glow"
        ></div>
        <div
          ref={horizontalProgressbarRef}
          className="absolute max-w-[45rem] max-laptop:!max-w-[32rem] ml-80  max-mobile:ml-[3rem] max-tablet:ml-[15rem] top-[3655px] max-mobile:top-[4245px] max-tablet:top-[2800px]  p-[2px] z-0 rounded-3xl bg-myTeal glow"
        ></div>
        <div
          ref={verticalProgressbarRef2}
          className="absolute max-h-[1848px] max-tablet:max-h-[1600px] ml-[65rem] max-laptop:!ml-[52rem] max-tablet:!ml-[47rem] max-mobile:!ml-[35rem] max-mobile:!top-[4245px] max-tablet:!top-[2800px] top-[3655px]  p-[2px] z-0 rounded-3xl bg-myTeal glow"
        ></div>
        <div
          ref={horizontalProgressbarRef2}
          className="absolute ml-[65rem] max-laptop:ml-[52rem] max-tablet:ml-[47.2rem] top-[5500px] max-tablet:top-[4400px]  p-[2px] z-0 rounded-3xl bg-myTeal glow"
        ></div>
