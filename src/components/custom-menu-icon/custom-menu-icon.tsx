...
function CustomMenuIcon({handleClick, isMenuOpen}:CustomMenuIconProps){
   ...
   const handleMenuHover =  (type: string) =>{
      ...
      if(!secondLineRef.current || !thirdLineRef.current){return}
      if(type === 'hover'){
   ...
   return(
      <div ref={menuIconRef} className=" flex flex-col items-end gap-2 w-9 hover:cursor-pointer  absolute opacity-75  -right-24"
