  ...
  return (
    <div className="flex flex-col  gap-44 relative">
      <div className="text-5xl max-mobileXS:text-lg max-tablet:text-[2rem] font-bold tracking-wide text-white leading-relaxed flex">
        <span>
          Hi, my name is{" "}
          <span className="text-myTeal ">Vasilis Dramitinos</span>
          <br></br>
      ...
      <div
        className="flex w-max gap-2 relative !right-12 max-mobile:!right-0 hover:cursor-pointer hoverClass"
        onClick={() => scrollWorkIntoView()}
      >
        <img
          src="https://dravasilis.github.io/my-portfolio/assets/svg/scroll.svg"
          alt="scroll"
          width={"30"}
        />
