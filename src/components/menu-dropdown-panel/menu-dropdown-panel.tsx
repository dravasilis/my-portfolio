...
function MenuDropdownPanel({isMenuOpen, setIsMenuOpen}:MenuDropdownPanelProps){
   ...
   return(
      <div ref={menuPanelRef} className="panelGlass  absolute -top-[100vh] left-0  duration-500 w-[100vw] h-[100vh]">
         <div className="w-full h-full flex  items-center justify-around max-[1450px]:gap-[12rem]   ">
            <div className="flex flex-col gap-8 max-mobile:ml-4  w-24">
            ...
            <div className="flex flex-col gap-16 w-[30rem] max-mobile:mr-4">
               <span className=" text-5xl max-mobile:text-[2rem] font-bold text-white">Let's work together!</span>
               <span className=" text-2xl max-mobile:text-xl text-white leading-relaxed tracking-wide">Feeling ready for our first collaboration? Feel free to contact me down below!</span>
